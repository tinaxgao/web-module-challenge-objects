...
*/
console.log(createMenuItem(`Spinach Salad`, 9, `Salads`));
console.log(createMenuItem(`Impossible Burger`, 12, `Sandwiches`));
console.log(createMenuItem(`Chocolate Cake`, 6, `Desserts`));
